...
<Frame>
    <img class="image-center" src="https://docs.cognigy.com/_assets/voice-gateway/VG-logo.png" width="80%" />
</Frame>
...
<Frame>
   <img class="image-center"  src="https://docs.cognigy.com/_assets/voice-gateway/VG-nodes-overview.png"  width="80%" />
</Frame>
...
4. In the **New Endpoint** section, do the following:
    1. Select the **voice-gateway** Endpoint type.
    2. Add a unique name.
    3. Select a relevant Flow from the list.
5. Click **Save**.

<Frame>
   <img class="image-center" src="https://docs.cognigy.com/_assets/voice-gateway/VG-endpoint-new.png" width="100%" />
</Frame>
