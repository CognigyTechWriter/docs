...
<Frame>
    <img class="image-center" src="https://docs.cognigy.com/_assets/ai/build/node-reference/basic/optional-question.png" width="50%" />
</Frame>
...
<AccordionGroup>
    ...
    <Info>Supported Data Formats for System-Defined Slots:bAll data formats supported by the Cognigy NLU for system slot mapping are listed on the [Slot Mapping](../../../empower/nlu/slots-and-lexicons/slots.md) page.</Info>
    </Accordion>
    ...
    <Tip>If you select the Date as a Question Type, the Question Node automatically renders a datepicker if the channel supports it. Refer to [Datepicker](../data/datepicker.md) for more information. </Tip>
