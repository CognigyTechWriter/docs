...
<Tabs>
  <Tab title="GUI">
     ...
     <AccordionGroup>
       <Accordion title="1. General Setting">
       ...
       <Accordion title="2. Speaking Style">
       ...
       <Accordion title="3. Knowledge & Instructions">
        ...
        <Accordion title="4. Data Privacy & Security">
        ...
        <Accordion title="5. Job Selection">
