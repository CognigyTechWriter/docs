...
??? info "Notifications"
    ...
    |-------------------|------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------|
    | Success message   | Displays when a Task is completed successfully.                                                                                                      | <Frame><img class="image-center" src="../../../../_assets/ai/overview/user-interface/success-message.png" width="70%" /></Frame> |
    | Warning message   | Display when a Task is completed with a warning. Click ![arrow-down](../../../_assets/icons/arrow-down.svg) to view the warning message. | <Frame><img class="image-center" src="../../../../_assets/ai/overview/user-interface/warning-message.png" width="70%" /></Frame> |
    | Error message     | Displays when a Task fails. Click ![arrow-down](../../../_assets/icons/arrow-down.svg) to view the error message.                        | <Frame><img class="image-center" src="../../../../_assets/ai/overview/user-interface/error-message.png" width="70%" /></Frame>   |
